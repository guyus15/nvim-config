    ...
    config = function()
        ...
        vim.api.nvim_create_autocmd("LspAttach", {
            ...
            callback = function(event)
                ...
                map("<F12>", require("telescope.builtin").lsp_definitions, "Go to Definition")
                map("<S-F12>", require("telescope.builtin").lsp_references, "Go to References")
                map(
                    "<S-A-F12>",
                ...
                -- Keep some of the original keybindings for additional functionality
